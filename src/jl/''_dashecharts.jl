...
function ''_dashecharts(; kwargs...)
        available_props = Symbol[:id, :add_legend, :bmap_token, :brushSelected_data, :brush_data, :click_data, :event, :fun_effects, :fun_keys, :fun_paths, :fun_prepares, :fun_values, :funs, :mapbox_token, :maps, :n_clicks, :n_clicks_timestamp, :opt_merge, :option, :part_of_opt, :reset_id, :resize_id, :selected_data, :style, :zoom_data]
        wild_props = Symbol[]
